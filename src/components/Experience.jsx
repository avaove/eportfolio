...
const ExpCard = (props) => {
  ...
  if (props.img != "") {
    image = <MDBCardImage className='exp-img' position='bottom' src={process.env.PUBLIC_URL + props.img} overlay='white-slight' hover waves />
  ...
  return (
    <MDBCard narrow col='4' className='exp-card'>
      <MDBCardBody>
        ...
        <MDBCardSubTitle><a className="company" href={props.link}>{props.company}</a></MDBCardSubTitle>
